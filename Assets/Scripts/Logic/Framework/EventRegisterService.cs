...
namespace Lockstep.Game
{
    public class EventRegisterService : IEventRegisterService 
    {
        ...
        {
            RegisterEvent<EEvent, GlobalEventHandler>("OnEvent_", "OnEvent_".Length, EventHelper.RemoveListener, obj);
        }

        public void RegisterEvent(object obj)
        {
            RegisterEvent<EEvent, GlobalEventHandler>("OnEvent_", "OnEvent_".Length, EventHelper.AddListener, obj);
        }
